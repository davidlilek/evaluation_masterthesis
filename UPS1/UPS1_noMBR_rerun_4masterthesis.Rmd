...
path = "N:/1_A_Bachelor_Master_Intern/00_M_2022/David/Data/2_UPS1/UPS1_noMBR_rerun_4masterthesis/"
...
```{r}
i = 0
res_pool_razor_10fmol <- c()
res_pool_razor_25fmol <- c()
res_pool_razor_2fmol <- c()
res_pool_razor_4fmol <- c()
res_pool_razor_50fmol <- c()
for (i in 1:10){
  tmp <- apply(results_razor[[i]][1:3], 1, any)
  res_pool_razor_10fmol <- c(res_pool_razor_10fmol, length(tmp[tmp == TRUE]))
  tmp <- apply(results_razor[[i]][4:6], 1, any)
  res_pool_razor_25fmol <- c(res_pool_razor_25fmol, length(tmp[tmp == TRUE]))
  tmp <- apply(results_razor[[i]][7:9], 1, any)
  res_pool_razor_2fmol <- c(res_pool_razor_2fmol, length(tmp[tmp == TRUE]))
  tmp <- apply(results_razor[[i]][10:12], 1, any)
  res_pool_razor_4fmol <- c(res_pool_razor_4fmol, length(tmp[tmp == TRUE]))
  tmp <- apply(results_razor[[i]][13:15], 1, any)
  res_pool_razor_50fmol <- c(res_pool_razor_50fmol, length(tmp[tmp == TRUE]))
}
```
...
```{r}
i = 0
res_pool_unique_10fmol <- c()
res_pool_unique_25fmol <- c()
res_pool_unique_2fmol <- c()
res_pool_unique_4fmol <- c()
res_pool_unique_50fmol <- c()


for (i in 1:10){
  tmp <- apply(results_unique[[i]][1:3], 1, any)
  res_pool_unique_10fmol <- c(res_pool_unique_10fmol, length(tmp[tmp == TRUE]))
  tmp <- apply(results_unique[[i]][4:6], 1, any)
  res_pool_unique_25fmol <- c(res_pool_unique_25fmol, length(tmp[tmp == TRUE]))
  tmp <- apply(results_unique[[i]][7:9], 1, any)
  res_pool_unique_2fmol <- c(res_pool_unique_2fmol, length(tmp[tmp == TRUE]))
  tmp <- apply(results_unique[[i]][10:12], 1, any)
  res_pool_unique_4fmol <- c(res_pool_unique_4fmol, length(tmp[tmp == TRUE]))
  tmp <- apply(results_unique[[i]][13:15], 1, any)
  res_pool_unique_50fmol <- c(res_pool_unique_50fmol, length(tmp[tmp == TRUE]))
}
```
...
```{r}
i = 0
res_pool_lfq_10fmol <- c()
res_pool_lfq_25fmol <- c()
res_pool_lfq_2fmol <- c()
res_pool_lfq_4fmol <- c()
res_pool_lfq_50fmol <- c()


for (i in 1:10){
  sub <- results_lfq[[i]][1:3]
  tmp <- sub[rowSums(is.na(sub)) != ncol(sub), ]
  res_pool_lfq_10fmol <- c(res_pool_lfq_10fmol, nrow(tmp))
  
  sub <- results_lfq[[i]][4:6]
  tmp <- sub[rowSums(is.na(sub)) != ncol(sub), ]
  res_pool_lfq_25fmol <- c(res_pool_lfq_25fmol, nrow(tmp))
  
  sub <- results_lfq[[i]][7:9]
  tmp <- sub[rowSums(is.na(sub)) != ncol(sub), ]
  res_pool_lfq_2fmol <- c(res_pool_lfq_2fmol, nrow(tmp))
  
  sub <- results_lfq[[i]][10:12]
  tmp <- sub[rowSums(is.na(sub)) != ncol(sub), ]
  res_pool_lfq_4fmol <- c(res_pool_lfq_4fmol, nrow(tmp))
  
  sub <- results_lfq[[i]][13:15]
  tmp <- sub[rowSums(is.na(sub)) != ncol(sub), ]
  res_pool_lfq_50fmol <- c(res_pool_lfq_50fmol, nrow(tmp))
...
```{r}
res <- data.frame(cbind(res_pool_razor_10fmol,
                        res_pool_razor_25fmol,
                        res_pool_razor_2fmol,
                        res_pool_razor_4fmol,
                        res_pool_razor_50fmol,
                        res_pool_unique_10fmol,
                        res_pool_unique_25fmol,
                        res_pool_unique_2fmol,
                        res_pool_unique_4fmol,
                        res_pool_unique_50fmol,
                        res_pool_lfq_10fmol,
                        res_pool_lfq_25fmol,
                        res_pool_lfq_2fmol,
                        res_pool_lfq_4fmol,
                        res_pool_lfq_50fmol))
colnames(res) <- paste(rep(c("Razor_", "Unique_", "LFQ_"),each = 5),rep(c("10fmol","25fmol","2fmol","4fmol","50fmol"),3),sep="")
write.csv2(res, file = "./tmpfiles/UPS1_noMBR_rerun.csv")
```
