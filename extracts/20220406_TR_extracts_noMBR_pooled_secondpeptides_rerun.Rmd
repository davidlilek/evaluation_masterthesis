...
path = "N:/1_A_Bachelor_Master_Intern/00_M_2022/David/Data/3_20220406_TR/20220406_TR_extracts_noMBR_pooled_secondpeptides_rerun_4masterthesis/"
...
for (x in file.list){
  ...
  data_raw$Only.identified.by.site[is.na(data_raw$Only.identified.by.site)] <- ""
...
```{r}
res <- data.frame(cbind(results_2gether_razor[,-7],results_2gether_unique[,-7],results_2gether_lfq[,-7]))
colnames(res) <- paste(rep(c("Razor_", "Unique_", "LFQ_"),each = 6),rep(LETTERS[1:6],1),sep="")
write.csv2(res, file = "./tmpfiles/20220406_TR_extracts_noMBR_pooled_secondpeptides_rerun.csv")
```
