...
```{r}
knitr::kable(result_df[[1]], booktabs = T, "latex")
knitr::kable(result_df[[2]], booktabs = T, "latex")
knitr::kable(result_df[[3]], booktabs = T, "latex")
knitr::kable(result_df[[4]], booktabs = T, "latex")
knitr::kable(result_df[[5]], booktabs = T, "latex")
knitr::kable(result_df[[6]], booktabs = T, "latex")
```
